...
export const TrustIndicators = memo(function TrustIndicators() {
  ...
  return (
    <>
      <section
        className="py-8 sm:py-12 md:py-14 px-3 sm:px-6 lg:px-8 bg-gradient-to-r from-amber-50/80 via-background to-amber-50/80 dark:from-amber-950/20 dark:via-background dark:to-amber-950/20 border-t-2 border-b-2 border-amber-200 dark:border-amber-800"
        ...
        <div className="w-full max-w-[1700px] mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
            {trustBadges.map((badge) => (
              <div
                key={badge.title}
                className="flex flex-col items-center text-center p-3.5 sm:p-5 md:p-6 rounded-2xl border-2 border-amber-300/70 dark:border-amber-700/60 bg-card shadow-2xs hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group"
              >
                <div
                  className="inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-amber-500/20 border-2 border-amber-400/40 mb-3 transition-transform duration-300 group-hover:scale-105 shadow-2xs"
                >
      ...
      <section
        className="py-8 sm:py-12 md:py-16 px-3 sm:px-6 lg:px-8 bg-gradient-to-br from-primary via-green-600 to-emerald-700 text-white"
        style={{ contentVisibility: "auto", containIntrinsicSize: "520px" }}
      >
        <div className="w-full max-w-[1700px] mx-auto">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-10 items-center">
            <div>
              <span className="text-white/90 font-black text-xs sm:text-sm uppercase tracking-widest bg-white/20 px-3 py-1 rounded-full border border-white/30 shadow-2xs">
                Join Our Community
              </span>
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black mt-2.5 sm:mt-3 mb-3 sm:mb-4 leading-tight drop-shadow-md">
                Ready to Start
                <br />
                Your Journey?
              </h2>
              <p className="text-white/95 text-xs sm:text-sm md:text-base font-bold mb-5 sm:mb-6 max-w-md leading-relaxed drop-shadow-xs">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <Button
                  asChild
                  size="lg"
                  className="h-11 sm:h-12 px-5 sm:px-7 text-xs sm:text-sm font-black uppercase tracking-wider bg-white text-primary hover:bg-white/90 shadow-lg border-0"
                >
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="h-11 sm:h-12 px-5 sm:px-7 text-xs sm:text-sm font-black uppercase tracking-wider border-2 border-white/40 text-white hover:bg-white/15 backdrop-blur-xs"
                >
            ...
            >
              {communityLinks.map((item) => (
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-xl border-2 border-white/30 bg-white/20 p-3.5 sm:p-4 text-white transition-all duration-300 hover:-translate-y-0.5 hover:border-white/60 hover:bg-white/30 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-700 active:translate-y-0"
                >
                  <CheckCircle className="h-5 w-5 text-green-300 flex-shrink-0" />
                  <span className="min-w-0 flex-1 text-xs sm:text-sm md:text-base font-black uppercase tracking-wide">{item.label}</span>
                  <ArrowRight className="h-4 w-4 flex-shrink-0 text-white/80 transition-transform duration-300 group-hover:translate-x-1 group-hover:text-white" aria-hidden="true" />
                </Link>
              ))}
            </div>
          </div>
