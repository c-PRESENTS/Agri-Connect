    ...
    <section className="py-4 sm:py-8 md:py-10 px-3 sm:px-6 lg:px-8" style={{ contentVisibility: "auto", containIntrinsicSize: "400px" }}>
      <div className="w-full max-w-[1700px] mx-auto">
        ...
        <div 
          ...
          className="flex gap-3.5 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory -mx-3 px-3 sm:mx-0 sm:gap-4.5 sm:px-0 sm:pb-5 md:gap-5.5"
        ...
        >
          {carouselCategories.map((category) => {
            ...
            return (
              <div
                key={category.id}
                className="w-[185px] flex-shrink-0 snap-start sm:w-[225px] md:w-[255px] lg:w-[280px]"
              >
                <Card 
                  className="group relative h-[230px] cursor-pointer overflow-hidden rounded-2xl border-2 border-transparent shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-primary/60 hover:shadow-xl sm:h-[270px] md:h-[300px] lg:h-[320px]"
                ...
                >
                  ...
                  <div className="relative z-10 flex h-full flex-col justify-end p-3.5 sm:p-4.5 md:p-5">
                    <div
                      className="mb-2.5 flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl border border-white/30 bg-white/30 p-1 shadow-md backdrop-blur-md transition-transform duration-300 group-hover:scale-110 sm:h-10 sm:w-10 md:h-11 md:w-11"
                    >
                      {bgImage ? (
                        ...
                        <IconComponent className="h-4.5 w-4.5 text-white drop-shadow-sm sm:h-5 sm:w-5 md:h-6 md:w-6" />
                      )}
                    </div>
                    ...
                    <p className="mb-2.5 text-xs font-black text-white/95 drop-shadow-sm sm:mb-3 sm:text-sm">
                      {category.subcategories.length} subcategories
                    </p>
                    <Button 
                      variant="secondary" 
                      size="sm"
                      className="h-8.5 w-fit rounded-lg border border-amber-500/50 bg-amber-400 px-3.5 text-xs font-black uppercase tracking-wider text-black shadow-md hover:bg-amber-500 sm:h-9.5 sm:px-4.5 sm:text-xs"
                    >
                      {t("category.see_all")}
                      <ArrowRight className="ml-1.5 h-3.5 w-3.5 text-black sm:ml-2 sm:h-4 sm:w-4" />
                    </Button>
                  </div>
                </Card>
              </div>
