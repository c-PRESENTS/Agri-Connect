...
export function AppNavRail() {
  ...
  return (
    <>
      <aside
        className={`hidden lg:flex flex-col bg-white dark:bg-sidebar border-slate-200 dark:border-border/40 shrink-0 select-none z-50 h-screen transition-all duration-200 ease-in-out overflow-hidden ${
          expanded ? "border-r opacity-100" : "border-r-0 opacity-0 pointer-events-none"
        }`}
        ...
        <div className="p-3.5 border-b border-slate-100 dark:border-border/40 bg-white/80 dark:bg-card/40 backdrop-blur-xs">
          <div className="flex items-center justify-between gap-2.5">
            <button
              ...
              className="flex items-center gap-2.5 min-w-0 flex-1 hover:opacity-90 transition-all text-left cursor-pointer group rounded-xl p-1 -m-1 hover:bg-slate-50 dark:hover:bg-card/60"
              title="Hide sidebar"
              aria-label="Hide sidebar"
              data-testid="button-nav-rail-toggle"
            >
              ...
              <div className="min-w-0 flex-1 flex items-center justify-between">
                ...
                <div className="h-7 w-7 rounded-lg flex items-center justify-center text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-200 group-hover:bg-slate-100 dark:group-hover:bg-border/40 transition-colors shrink-0 ml-1" title="Hide sidebar">
                  ...
                  {sectionItems.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        title={item.label}
                        className={`w-full flex items-center px-3 py-2 gap-3 rounded-xl transition-all duration-150 ${
                          isActive
