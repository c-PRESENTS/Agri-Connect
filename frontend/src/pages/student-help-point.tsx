      ...
      <main id="main-content" className="mx-auto max-w-7xl px-4 py-8 sm:py-12">
        ...
        {section === "dashboard" && (
          <div className="space-y-8">
            ...
            <section aria-labelledby="bio-cycle-heading" className="mt-8">
              <Card className="rounded-3xl border-2 border-primary/30 bg-gradient-to-br from-background via-muted/20 to-primary/5 shadow-xl overflow-hidden">
                <CardHeader className="p-6 sm:p-8 pb-4">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <Badge variant="outline" className="mb-2 text-xs font-black uppercase tracking-wider px-3 py-1 border-primary/40 text-primary">
                        Agricultural Education &amp; Lifelong Roadmap
                      </Badge>
                      <CardTitle id="bio-cycle-heading" className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-foreground">
                        Component B: The Redesigned Human Bio-Cycle
                      </CardTitle>
                    </div>
                    <Badge className="bg-primary/20 text-primary border border-primary/30 text-xs sm:text-sm font-black px-3.5 py-1.5">
                      7 Stages of Purpose
                    </Badge>
                  </div>
                  <p className="mt-2 text-sm sm:text-base font-bold text-foreground/80">
                ...
                <CardContent className="p-4 sm:p-6 md:p-8 pt-0">
                  <div className="relative rounded-2xl border-2 border-border/70 bg-black/5 dark:bg-black/40 overflow-hidden shadow-inner flex items-center justify-center p-2 sm:p-4">
                    <img
                      ...
                      className="w-full h-auto max-h-[650px] object-contain rounded-xl shadow-md transition-transform duration-300 hover:scale-[1.01]"
                      loading="lazy"
                    />
                  </div>
                  <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2.5 text-center">
