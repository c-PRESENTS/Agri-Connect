...
export const categories: Category[] = [
  {
    ...
    subcategories: [
      ...
      { id: "flowers", name: "Flowers & Decoratives", parentId: "daily-needs" },
      { id: "organic-produce", name: "Organic Produce", parentId: "daily-needs" },
      { id: "dairy-animals", name: "Dairy Animals", parentId: "daily-needs" },
      { id: "meat-animals", name: "Meat Animals", parentId: "daily-needs" },
      { id: "poultry", name: "Poultry Birds", parentId: "daily-needs" },
      { id: "aquaculture", name: "Fish & Aquaculture Stock", parentId: "daily-needs" },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: "precision", name: "Precision Farming Tools", parentId: "modern-farming" },
    ],
  },
  {
    id: "dietary",
...
export const categoryExamples: Record<string, string[]> = {
  ...
  "vegetables": [
    ...
    "Tomato", "Brinjal", "Capsicum", "Okra", "Chilli",
    "Bottle Gourd", "Bitter Gourd", "Snake Gourd", "Ridge Gourd", "Pumpkin",
    "Beans", "Peas", "Broad Beans",
    "Cauliflower", "Broccoli", "Cabbage", "Cucumber", "Turnip", "Yam", "Tapioca"
  ],
  "fruits": [
    "Banana", "Mango", "Papaya", "Pineapple", "Guava", "Jackfruit",
    "Orange", "Lemon", "Sweet Lime", "Grapefruit", "Pomelo",
    "Strawberry", "Blueberry", "Raspberry", "Blackberry",
    "Watermelon", "Muskmelon", "Honeydew Melon",
    "Plum", "Peach", "Cherry", "Apricot",
    "Apple", "Pear", "Green Grapes", "Black Grapes", "Seedless Grapes",
    "Kiwi", "Dragon Fruit", "Avocado", "Persimmon", "Rambutan"
  ],
  "dairy": [
  ...
  "wholesale-veg": [
    "All Vegetables in Bulk", "Organic Vegetables",
    "Zucchini", "Broccoli", "Asparagus", "Bell Peppers", "Lettuce varieties"
  ],
  "wholesale-fruits": [
    "All Fruits in Bulk", "Organic Fruits",
    "Kiwi", "Dragon Fruit", "Avocado", "Blueberries"
  ],
  "flowers": [
...
export const productData: Record<string, { name: string; price: number; unit: string; image?: string }[]> = {
  ...
  "vegetables": [
    ...
    { name: "Beans", price: 55, unit: "kg", image: vegetablesImg },
    { name: "Peas", price: 80, unit: "kg", image: vegetablesImg },
  ],
  "fruits": [
    { name: "Mango", price: 80, unit: "kg", image: mangoImg },
    { name: "Banana", price: 40, unit: "dozen", image: bananaImg },
    { name: "Apple", price: 150, unit: "kg", image: appleImg },
    { name: "Orange", price: 60, unit: "kg", image: orangeImg },
    { name: "Grapes", price: 80, unit: "kg", image: grapesImg },
    ...
    { name: "Coconut", price: 35, unit: "piece", image: fruitsImg },
