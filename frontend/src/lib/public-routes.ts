export const PUBLIC_ROUTE_LINKS = [
  ...
  { path: "/farmers-help/student", seoKey: "dashboard" },
  { path: "/farmers-help/student/resources", seoKey: "farmersHelp" },
  { path: "/farmers-help/student/support", seoKey: "support" },
  { path: "/farmers-help/student/requests", seoKey: "support" },
