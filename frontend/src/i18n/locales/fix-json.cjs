...
const taRaw = fs.readFileSync('C:/Agri-Connect/frontend/src/i18n/locales/ta.json', 'utf8');
...
console.log('Written. Size: ' + fs.statSync('C:/Agri-Connect/frontend/src/i18n/locales/ta.json').size + ' bytes');

// Validate
try {
    const v = JSON.parse(fs.readFileSync('C:/Agri-Connect/frontend/src/i18n/locales/ta.json', 'utf8'));
