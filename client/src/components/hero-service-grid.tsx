...
const ALL_ITEMS = [
  { id: "seller",     path: "/seller",                    icon: BadgeDollarSign, label: "Seller Hub",    color: "text-yellow-400",  public: true  },
  { id: "sell",       path: "/dashboard/photo-sell",      icon: Camera,          label: "Sell / List",   color: "text-emerald-400", public: false },
  { id: "daily",      path: "/?category=daily-needs",      icon: ShoppingBasket,  label: "Daily Needs",   color: "text-green-400",   public: true  },
  { id: "map",        path: "/map",                        icon: Map,             label: "Smart Map",     color: "text-sky-400",     public: true  },
  { id: "help",       path: "/farmers-help",               icon: Sprout,          label: "Help Point",    color: "text-lime-400",    public: true  },
  { id: "dash",       path: "/dashboard",                  icon: LayoutDashboard, label: "Dashboard",     color: "text-violet-400",  public: false },
  { id: "settings",   path: "/settings",                   icon: Settings,        label: "Settings",      color: "text-slate-300",   public: false },
  { id: "inputs",     path: "/?category=inputs-tools",     icon: Wrench,          label: "Inputs & Tools",color: "text-blue-400",    public: true  },
  { id: "processed",  path: "/?category=processed",        icon: Package,         label: "Processed",     color: "text-amber-400",   public: true  },
  { id: "specialty",  path: "/?category=specialty",        icon: Star,            label: "Specialty",     color: "text-yellow-400",  public: true  },
  { id: "other",      path: "/?category=other-agri",       icon: Wheat,           label: "Other Agri",    color: "text-yellow-300",  public: true  },
  { id: "super",      path: "/?category=supermarket",      icon: Store,           label: "Supermarket",   color: "text-purple-400",  public: true  },
  { id: "services",   path: "/?category=services",         icon: Cog,             label: "Farm Services", color: "text-gray-300",    public: true  },
  { id: "schemes",    path: "/government-schemes",         icon: Building2,       label: "Govt Schemes",  color: "text-indigo-400",  public: true  },
  { id: "agritech",   path: "/agritech",                   icon: Cpu,             label: "AgriTech",      color: "text-cyan-400",    public: true  },
  { id: "dietary",    path: "/?category=dietary",          icon: Heart,           label: "Dietary",       color: "text-pink-400",    public: true  },
  { id: "land",       path: "/land-leasing",               icon: Landmark,        label: "Land Leasing",  color: "text-emerald-300", public: true  },
  { id: "logistics",  path: "/logistics",                  icon: Truck,           label: "Logistics",     color: "text-blue-300",    public: true  },
  { id: "share",      path: "/share-care",                 icon: HeartHandshake,  label: "Share & Care",  color: "text-rose-400",    public: true  },
  { id: "commercial", path: "/?category=commercial-crops", icon: Factory,         label: "Commercial",    color: "text-slate-400",   public: true  },
  { id: "bio",        path: "/?category=bio-products",     icon: Leaf,            label: "Bio Products",  color: "text-teal-400",    public: true  },
];
  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between mb-1.5 sm:mb-2 px-0.5">
        <span className="text-[9px] font-black uppercase tracking-[0.18em] text-white/40">Quick Access</span>
      ...
      {editMode && hiddenItems.length > 0 && (
        <div className="mt-2 pt-2 border-t border-dashed border-white/10">
          <p className="text-[8px] uppercase tracking-widest text-white/30 font-bold mb-1.5">Hidden — tap to restore</p>
